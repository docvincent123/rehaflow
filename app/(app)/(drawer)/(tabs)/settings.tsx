...
import { Bell, Building2, LogOut, RefreshCw, ShieldCheck, UserRound, Volume2, Vibrate, Wifi, LockKeyhole } from 'lucide-react-native';
  ...
  return (
    <View className="bg-background flex-1">
      ...
      <ScrollView contentContainerClassName="gap-4 px-4 pb-10 pt-4">
        ...
        <SectionCard title="Про програму">
          <View className="flex-row items-center gap-3 rounded-2xl border border-border bg-surface px-4 py-4"><View className="h-11 w-11 items-center justify-center rounded-xl bg-accent-soft"><Building2 color={navColors.accent} size={22} /></View><View className="flex-1"><Text className="text-foreground text-base font-bold">RehaFlow</Text><Text className="text-muted mt-0.5 text-xs">Мобільний клієнт системи реабілітаційного центру</Text></View></View>
          <View className="mt-3"><InfoRow label="Розробник" value="QureMed Industries" /><InfoRow label="Призначення" value="Лікарі • медсестри • реабілітологи" /><InfoRow label="Версія" value="1.6.21" /></View>
        </SectionCard>
